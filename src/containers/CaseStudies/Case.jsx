...
//     const leftEdgeIndex =
//       (targetIndex - 1 + projectData.length) % projectData.length;
//     loopRef.current.toIndex(leftEdgeIndex, {
//       duration: 0.4,
//       ease: "power1.inOut",
//     });
//   };
...
//         <ProjectCard ref={cardsRef} activeIndex={activeIndex} />
...
//       xPercents[i] = snap(
//         parseFloat(gsap.getProperty(target, "xPercent", "%")) +
//           (gsap.getProperty(target, "x", "px") / w) * 100,
//       );
//       return xPercents[i];
//     },
//   });
